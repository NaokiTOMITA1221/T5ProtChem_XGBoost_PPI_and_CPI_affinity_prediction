...
blue markers for T0 (m=0) samples, red for the rest, matching Figure S24's
own color coding.
"""
import os
...
OUT_PNG = os.path.join(REPO, "results", "hoshino_correlation_scatter.png")
N_RESAMPLES = 99999
PERM_SEED = 42
...
print(f"pearson r={r:.4f} (permutation p={p:.5f}), spearman rho={rho:.4f} (permutation p={p_rho:.5f})")
